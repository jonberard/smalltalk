...
export default function CreateTestLinkClient() {
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-[#F8F9FA] px-4 font-dashboard">
      <div className="w-full max-w-[480px]">
        <h1 className="mb-2 text-[22px] font-bold text-[#18181B]">
          Create Test Review Link
        </h1>
        ...
        {url ? (
          <div className="rounded-[12px] border border-[#E4E4E7] bg-white p-6">
            <p className="mb-3 text-[12px] font-semibold uppercase tracking-wider text-[#71717A]">
              Your test link
            </p>
            <a
              href={url}
