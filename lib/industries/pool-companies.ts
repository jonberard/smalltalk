...
export const poolCompaniesData: IndustryPageData = {
  ...
  metaTitle: "Google Review Software for Pool Companies — small Talk",
  metaDescription: "Get more detailed Google reviews from your pool cleaning, repair, and construction customers. small Talk guides them through a 30-second conversation and drafts the review from their real answers. Built for pool service businesses.",
  openGraphDescription: "Get more detailed Google reviews from your pool cleaning, repair, and construction customers. Built for pool service businesses.",
  ogImageAlt: "small Talk — Google review software for pool companies",
  softwareDescription: "Google review management software for pool service businesses.",
  hero: {
