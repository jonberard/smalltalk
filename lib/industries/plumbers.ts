...
export const plumbersData: IndustryPageData = {
  ...
  metaTitle: "Help Plumbing Customers Actually Write Google Reviews | small Talk",
  metaDescription: "small Talk helps emergency, repair, and installation plumbing customers get past the blank box and leave detailed Google reviews from their real experience.",
  openGraphDescription: "Turn “you saved us” into a detailed Google review the next homeowner will actually trust.",
  ogImageAlt: "small Talk — Google review software for plumbers",
  softwareDescription: "small Talk helps plumbing customers actually write the Google review they meant to leave.",
  hero: {
