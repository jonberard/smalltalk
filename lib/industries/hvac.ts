...
export const hvacData: IndustryPageData = {
  ...
  metaTitle: "Google Review Software for HVAC Companies — small Talk",
  metaDescription: "Get more detailed Google reviews from your HVAC service and repair customers. small Talk guides them through a 30-second conversation and drafts the review from their real answers. Built for HVAC businesses.",
  openGraphDescription: "Get more detailed Google reviews from your HVAC service and repair customers. Built for HVAC businesses.",
  ogImageAlt: "small Talk — Google review software for HVAC companies",
  softwareDescription: "Google review management software for HVAC businesses.",
  hero: {
