...
export const contractorsData: IndustryPageData = {
  ...
  metaTitle: "Help Contractor Clients Actually Write Google Reviews | small Talk",
  metaDescription: "small Talk helps renovation and remodeling customers get past the blank box and leave detailed Google reviews from their real experience.",
  openGraphDescription: "Turn “the kitchen looks amazing” into a detailed Google review the next homeowner will actually trust.",
  ogImageAlt: "small Talk — Google review software for contractors and remodelers",
  softwareDescription: "small Talk helps contractor and remodeler clients actually write the Google review they meant to leave.",
  hero: {
