...
export const landscapersData: IndustryPageData = {
  ...
  metaTitle: "Help Landscaping Customers Actually Write Google Reviews | small Talk",
  metaDescription: "small Talk helps landscaping, lawn care, and hardscape customers get past the blank box and leave detailed Google reviews from their real experience.",
  openGraphDescription: "Turn “the yard looks incredible” into a detailed Google review that shows off the work you actually did.",
  ogImageAlt: "small Talk — Google review software for landscaping companies",
  softwareDescription: "small Talk helps landscaping customers actually write the Google review they meant to leave.",
  hero: {
